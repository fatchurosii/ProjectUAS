...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/employeer.css" />
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class='nav-item'>
                            <button class='btn btn-primary btn-sm mr-2 ml-md-4 mb-2' id='login' data-toggle='modal' data-target='#modalLogin'>Login</button>
                        </li>
                        <li class='nav-item'>
                            <button class='btn btn-primary btn-sm  mr-2 ' data-toggle='modal' data-target='#modalReg'>Register</button>
                        </li>
                        ";
                        } else {
                            echo "
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                ...
                <div class="text1">
                <h2>Cari Talenta Muda dan Professional</h2>
                </div>
                <div class="text2">
                <h2>Dengan Pasang Iklan Gratis Disini Sekarang</h2>
                </div>
                </div> 
                <a class="btn btn-primary btn-md custom-iklan text-white">Pasang Iklan!</a>             
            </div>
        </div>
    </div>
